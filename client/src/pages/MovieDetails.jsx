...
const MovieDetails = () => {
    ...
    // Nếu id thay đổi, gọi lại hàm getShow
    useEffect(() => {
        getShow();
    }, [id]);
        ...
        <div className="px-6 md:px-16 lg:px-40 pt-30 md:pt-50">
            <div className="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
                ...
                <div className="relative flex flex-col gap-3">
                    ...
                    <p className="text-gray-400 mt-2 text-sm loading-tight max-w-xl">
                        {show.movie.overview}
                    </p>
              ...
              <div className="flex items-center gap-4 w-max px-4">
                  {show.movie.casts.slice(0, 12).map((cast, index) => (
                    <div key={index} className="flex flex-col items-center text-center" >
                      <img src={image_base_url + cast.profile_path} alt="" className="rounded-full h-20 md:h20 aspect-square object-cover" />
            ...
            <p className="text-lg font-medium mt-20 mb-8">You May Also Link</p>
