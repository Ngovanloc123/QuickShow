    ...
    <div className='h-[calc(100vh-64px)] md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-300/20 text-sm'>
        ...
        <div className='w-full'>
            {adminNavLinks.map((link, index) => (
                // Như thẻ Link nhưng tự động active nếu đường dẫn của nó trùng với route hiên tại
                // isActive được cung cấp bởi thư viện, thay đổi dựa trên URL của trình duyệt
                // end => URL khớp chính xác isActive mới true
